...
func (s *Server) SnapshotStats() StatsSnapshot {
	...
	return StatsSnapshot{
		...
		MsgPerSec:         float64(inbound+outbound) / uptime.Seconds(),
...
func (s *Server) markInboundMessage()  { atomic.AddUint64(&s.inboundMessages, 1) }
func (s *Server) markOutboundMessage() { atomic.AddUint64(&s.outboundMessages, 1) }
